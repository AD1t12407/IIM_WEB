...
export default function MacBookAirOneRowFive({
  loremipsum,
  ...
  return (
    <div {...props}>
      <div className="w-full p-1 border-2 border-solid blue_gray_900_gray_900_01_border bg-blue_gray-900_01 shadow-xs rounded-[24px]">
        <div className="flex flex-col mt-[30px] mr-[9px] gap-2.5">
